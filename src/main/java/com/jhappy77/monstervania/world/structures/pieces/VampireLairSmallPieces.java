...
public class VampireLairSmallPieces {

    //TODO: Make sure you change this every time you add a new structure!
    private static final ResourceLocation PART_1 = new ResourceLocation(Monstervania.MOD_ID, "vampire_lair_small");
    ...
    public static void start(TemplateManager manager, BlockPos pos, Rotation rot, List<StructurePiece> pieces, Random rand){
        ...
        //TODO: Make sure you change this every time you add a new structure!
        pieces.add(new com.jhappy77.monstervania.world.structures.pieces.VampireLairSmallPieces.Piece(manager, PART_1, blockPos, rot));
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos,
                     Rotation rotationIn) {
            //TODO: Make sure you change this every time you add a new structure!
            super(UnconfiguredStructures.VAMPIRE_LAIR_SMALL_PIECE, 0);
            this.resourceLocation = resourceLocationIn;
            //TODO: Make sure you change this every time you add a new structure!
            BlockPos blockpos = com.jhappy77.monstervania.world.structures.pieces.VampireLairSmallPieces.OFFSET.get(resourceLocation);
        ...
        public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            //TODO: Make sure you change this every time you add a new structure!
            super(UnconfiguredStructures.VAMPIRE_LAIR_SMALL_PIECE, tagCompound);
