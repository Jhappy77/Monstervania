...
public class SlimeCaveSmallStructure extends Structure<NoFeatureConfig> implements MvStructureSpawnable {
    public SlimeCaveSmallStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(Monstervania.MOD_ID, "slime_cave/start_pool")),
                            // Recursivity
                            10),
...
//            this.components.forEach(piece -> piece.getBoundingBox().minY += 1);
            ...
            Monstervania.LOGGER.debug("Small Slime Cave at " +
