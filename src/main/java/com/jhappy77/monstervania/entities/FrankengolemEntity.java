...
public class FrankengolemEntity extends MonsterEntity implements MvDamageModifiable {
    ...
    private void spawnEnergyParticles(){
        int j = this.world.rand.nextInt(10) + 15;
        for(int i=0; i<j; i++) {
        ...
        this.playSound(SoundInit.ENVIRONMENT_ELECTRICITY.get(), 0.7f, 1.0f);
    }
    ...
    public static List<MvSpawnCondition<MvMobSpawnInfo>> spawnConditions() {
        ...
        conditions.add(new MvSpawnCondition<MvMobSpawnInfo>(new MvMobSpawnInfo(3, 1, 1))
